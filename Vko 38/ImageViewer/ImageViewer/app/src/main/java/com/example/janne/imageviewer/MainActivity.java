package com.example.janne.imageviewer;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String PATH = "http://student.labranet.jamk.fi/~K1525/android-kuvat/";
    // example image names (change to your own if needed...)
    private String[] images = {"tornit.jpg","junarata.jpg", "metsa.png"};
    ...
    private class DownloadImageTask extends AsyncTask<String,Void,Bitmap> {
        ...
        protected Bitmap doInBackground(String... urls) {
            ...
            try {
                ...
                Log.e("LADATAAN KUVAA", e.getMessage());
            }
            return bitmap;
        }
